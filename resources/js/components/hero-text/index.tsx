      ...
      <div className={classes.inner}>
        ...
        <Container p={0} size={600}>
          <Text size="lg" c="dimmed" className={classes.description}>
            Upload notes, PDFs, or slides and our AI transforms them into interactive flashcard
            decks that help you study more efficiently, remember key ideas, and track your progress.
          </Text>
        </Container>
