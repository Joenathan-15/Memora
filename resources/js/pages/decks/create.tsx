            ...
            <Box component="form" onSubmit={handleAISubmit}>
                <Stack gap="sm">
                    <Dropzone
                        ...
                        accept={[MIME_TYPES.pdf, MIME_TYPES.ppt, MIME_TYPES.pptx, "odp"]}
                    >
                        <Group justify="center" gap="xl" mih={220} style={{ pointerEvents: 'none' }}>
                            ...
                            <Dropzone.Idle>
                                <IconPaperclip size={52} color="var(--mantine-color-dimmed)" stroke={1.5} />
                            </Dropzone.Idle>
                            ...
                            <div>
                                ...
                                <Text size="sm" c="dimmed" inline mt={7}>
                                    Attach a PDF or presentation (ppt/pptx/odp). Each file should not exceed 10 MB.
                                </Text>
                            </div>
                        </Group>
                    </Dropzone>
                    ...
                    <Group justify="space-between" align="center">
                        ...
                        <Button
                            type="submit"
                            loading={form.processing}
                            disabled={droppedFiles.length === 0 && !form.data.ai_file}
                        >
                            Generate with AI
                        </Button>
                    </Group>
