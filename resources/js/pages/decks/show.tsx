...
import { Button, Card, Center, Grid, Stack, Text, Timeline, Title } from '@mantine/core';
import { useMemo, useState } from 'react';
import AuthLayout from '@/layouts/auth-layout';

type Deck = { uuid: string; name?: string };
type Flashcard = { id: number | string; question: string; answer: string; next_review_date?: string };
...
export default function Show({ deck, dueCards: initialDue, futureCards, stats }: Props) {
    const { props } = usePage();
        ...
        <div style={{ maxWidth: 1024, margin: '0 auto', padding: 24 }}>
            ...
            {currentCard ? (
                ...
                >
                    ...
                    <Text c="dimmed" mt="xs">
                        You've reviewed all due cards. Come back tomorrow
                        for more practice.
                    </Text>
